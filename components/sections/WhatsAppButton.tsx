...
export function WhatsAppButton({
  ...
  const variantStyles = {
    ...
    ghost: "text-green-600 hover:text-green-700",
  };
  ...
  return (
    <Link href={whatsappLink} target="_blank" rel="noopener noreferrer">
      <div
        className={`${baseStyles} ${variantStyles[variant]} ${sizeStyles[size]} ${className} cursor-pointer hover:scale-105 active:scale-95`}
      >
        {/* WhatsApp Icon */}
        <svg
          className="w-5 h-5"
